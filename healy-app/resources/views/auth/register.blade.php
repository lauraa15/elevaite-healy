...
<head>
    ...
    <title>@yield('title', 'Register - Health Dashboard')</title>
                ...
                <div class="step-content" id="step2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="gender-options">
                            <div class="gender-option">
                                <input type="radio" class="gender-radio" id="male" name="gender" value="male" {{ old('gender') == 'male' ? 'checked' : '' }}>
                            ...
                            <div class="gender-option">
                                <input type="radio" class="gender-radio" id="female" name="gender" value="female" {{ old('gender') == 'female' ? 'checked' : '' }}>
                            ...
                            <div class="gender-option">
                                <input type="radio" class="gender-radio" id="other" name="gender" value="other" {{ old('gender') == 'other' ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input
                                type="text"
                                class="form-control with-icon @error('location') is-invalid @enderror"
                                id="location"
                                name="location"
                                value="{{ old('location') }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="activity-level-options">
                            <div class="activity-option">
                                <input type="radio" class="activity-radio" id="sedentary" name="activity_level" value="sedentary" {{ old('activity_level') == 'sedentary' ? 'checked' : '' }}>
                            ...
                            <div class="activity-option">
                                <input type="radio" class="activity-radio" id="light" name="activity_level" value="light" {{ old('activity_level') == 'light' ? 'checked' : '' }}>
                            ...
                            <div class="activity-option">
                                <input type="radio" class="activity-radio" id="moderate" name="activity_level" value="moderate" {{ old('activity_level') == 'moderate' ? 'checked' : '' }}>
                            ...
                            <div class="activity-option">
                                <input type="radio" class="activity-radio" id="very_active" name="activity_level" value="very_active" {{ old('activity_level') == 'very_active' ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('health_goals') is-invalid @enderror" name="health_goals" required>
                            <option value="">Select your primary goal</option>
                            <option value="weight_loss" {{ old('health_goals') == 'weight_loss' ? 'selected' : '' }}>Weight Loss</option>
                            <option value="weight_gain" {{ old('health_goals') == 'weight_gain' ? 'selected' : '' }}>Weight Gain</option>
                            <option value="maintain_weight" {{ old('health_goals') == 'maintain_weight' ? 'selected' : '' }}>Maintain Weight</option>
                            <option value="build_muscle" {{ old('health_goals') == 'build_muscle' ? 'selected' : '' }}>Build Muscle</option>
                            <option value="improve_fitness" {{ old('health_goals') == 'improve_fitness' ? 'selected' : '' }}>Improve Fitness</option>
                            <option value="better_sleep" {{ old('health_goals') == 'better_sleep' ? 'selected' : '' }}>Better Sleep</option>
                            <option value="stress_management" {{ old('health_goals') == 'stress_management' ? 'selected' : '' }}>Stress Management</option>
                        </select>
                        @error('health_goals')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
